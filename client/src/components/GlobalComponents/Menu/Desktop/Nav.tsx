         ...
         onClick={()=>handleClickRouter(item.title,item.link)}
          ...
          >
            ...
            <span
              className={
                navSpan === index
                  ? "w-100 rounded h-[100%] bg-[#1f1f1f] absolute z-[-1] right-0  top-[0] transition-[width] ease-in-out delay-150"
                  : "w-0 rounded h-[100%] bg-[#1f1f1f] absolute z-[-1] left-0  top-[0] transition-[width] ease-in-out delay-150"
              }
            ></span>
          </li>
        ))}
