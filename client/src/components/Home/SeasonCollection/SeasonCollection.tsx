...
const [data, setData] = useState(seasonStaticData)
  ...
  <Image
      ...
      <div className={"w-1/2 h-auto max-sm:w-100 bg-hBack flex justify-center items-center"}> 
      <div className={'w-97 h-[97%] max-sm:w-100  flex flex-wrap justify-between items-center'}>
    ...
    <p className={'font-[vazir] sm:text-[16px]  md:text-[17px] lg:text-[17px] text-[white] mb-[5px]'}>{item.title}</p>
    <p className={'font-[yekanBakhtBold] max-sm:text-[23px] md:text-[29px] lg:text-[50px] text-[white]'}>{item.description}</p>
      </div>
